...
(function (t, e) {
    function i() {
        ((this._curInst = null),
            ...
            (this._inDialog = !1),
            (this._mainDivId = 'ui-hktDatepicker-div'),
            ...
            (this.dpDiv = s(
                t(
                    `<div id='${
                        this._mainDivId
                    }' class='homekitTiles ui-datepicker ui-widget ui-widget-content ui-helper-clearfix'></div>`,
                ),
            )));
    }
    ...
    function s(e) {
        ...
        return e
            ...
            .delegate(i, 'mouseover', function () {
                t.hktDatepicker._isDisabledDatepicker(a.inline ? e.parent()[0] : a.input[0]) ||
    ...
    (t.extend(i.prototype, {
            ...
            (i.append && i.append.remove(),
                ...
                ('button' === s || 'both' === s) &&
                    ...
                    i.trigger.click(function () {
                        return (
                            t.hktDatepicker._datepickerShowing && t.hktDatepicker._lastInput === e[0]
                                ? t.hktDatepicker._hideDatepicker()
                                : t.hktDatepicker._datepickerShowing && t.hktDatepicker._lastInput !== e[0]
                                  ? (t.hktDatepicker._hideDatepicker(), t.hktDatepicker._showDatepicker(e[0]))
                                  : t.hktDatepicker._showDatepicker(e[0]),
                            !1
                        );
                    })));
        },
        ...
        _dialogDatepicker: function (e, i, s, a, o) {
            ...
            return (
                p ||
                    ...
                    (h = `dp${this.uuid}`),
                    (this._dialogInput = t(
                        `<input type='text' id='${h}' style='position: absolute; top: -100px; width: 0px;'/>`,
                    )),
        ...
        _optionDatepicker: function (i, s, a) {
            ...
            return 2 === arguments.length && 'string' == typeof s
                ? 'defaults' === s
                    ? t.extend({}, t.hktDatepicker._defaults)
                    : c
                      ? 'all' === s
                          ? t.extend({}, c.settings)
                          : this._get(c, s)
        ...
        _doKeyDown: function (e) {
            var i,
                s,
                n,
                a = t.hktDatepicker._getInst(e.target),
                r = !0,
                o = a.dpDiv.is('.ui-datepicker-rtl');
            if (((a._keyEvent = !0), t.hktDatepicker._datepickerShowing)) {
                switch (e.keyCode) {
                    case 9:
                    ...
                    case 13:
                        return (
                            (n = t(
                                `td.${t.hktDatepicker._dayOverClass}:not(.${t.hktDatepicker._currentClass})`,
                                a.dpDiv,
                            )),
                            n[0] && t.hktDatepicker._selectDay(e.target, a.selectedMonth, a.selectedYear, n[0]),
                            (i = t.hktDatepicker._get(a, 'onSelect')),
                            i
                                ? ((s = t.hktDatepicker._formatDate(a)), i.apply(a.input ? a.input[0] : null, [s, a]))
                                : t.hktDatepicker._hideDatepicker(),
                            !1
                        );
                    case 27:
                        ...
                        break;
                    case 33:
                        t.hktDatepicker._adjustDate(
                            e.target,
                            e.ctrlKey
                                ? -t.hktDatepicker._get(a, 'stepBigMonths')
                                : -t.hktDatepicker._get(a, 'stepMonths'),
                            'M',
                        );
                        break;
                    case 34:
                        ...
                        break;
                    case 35:
                        ((e.ctrlKey || e.metaKey) && t.hktDatepicker._clearDate(e.target),
                            (r = e.ctrlKey || e.metaKey));
                        break;
                    case 36:
                        ((e.ctrlKey || e.metaKey) && t.hktDatepicker._gotoToday(e.target),
                            (r = e.ctrlKey || e.metaKey));
                        break;
                    case 37:
                        ((e.ctrlKey || e.metaKey) && t.hktDatepicker._adjustDate(e.target, o ? 1 : -1, 'D'),
                            (r = e.ctrlKey || e.metaKey),
                        ...
                        break;
                    case 38:
                        ((e.ctrlKey || e.metaKey) && t.hktDatepicker._adjustDate(e.target, -7, 'D'),
                            (r = e.ctrlKey || e.metaKey));
                        break;
                    case 39:
                        ((e.ctrlKey || e.metaKey) && t.hktDatepicker._adjustDate(e.target, o ? -1 : 1, 'D'),
                ...
                36 === e.keyCode && e.ctrlKey ? t.hktDatepicker._showDatepicker(this) : (r = !1);
            }
        ...
        _doKeyPress: function (i) {
            var s,
                n,
                a = t.hktDatepicker._getInst(i.target);
            return t.hktDatepicker._get(a, 'constrainInput')
                ? ((s = t.hktDatepicker._possibleChars(t.hktDatepicker._get(a, 'dateFormat'))),
        ...
        _doKeyUp: function (e) {
            var i,
                s = t.hktDatepicker._getInst(e.target);
            if (s.input.val() !== s.lastVal) {
                try {
                    ((i = t.hktDatepicker.parseDate(
                        t.hktDatepicker._get(s, 'dateFormat'),
                        s.input ? s.input.val() : null,
                        t.hktDatepicker._getFormatConfig(s),
                    )),
                        i &&
                            (t.hktDatepicker._setDateFromField(s),
                            t.hktDatepicker._updateAlternate(s),
                            t.hktDatepicker._updateDatepicker(s)));
                } catch (n) {}
            }
            return !0;
        },
        _showDatepicker: function (e) {
            if (
                ...
                !t.hktDatepicker._isDisabledDatepicker(e) && t.hktDatepicker._lastInput !== e)
            ) {
                var i, s, a, r, o, h, l;
                ((i = t.hktDatepicker._getInst(e)),
                    t.hktDatepicker._curInst &&
                        t.hktDatepicker._curInst !== i &&
                        (t.hktDatepicker._curInst.dpDiv.stop(!0, !0),
                        i &&
                            t.hktDatepicker._datepickerShowing &&
                            t.hktDatepicker._hideDatepicker(t.hktDatepicker._curInst.input[0])),
                    (s = t.hktDatepicker._get(i, 'beforeShow')),
                    (a = s ? s.apply(e, [e, i]) : {}),
                    a !== !1 &&
                        (n(i.settings, a),
                        (i.lastVal = null),
                        (t.hktDatepicker._lastInput = e),
                        t.hktDatepicker._setDateFromField(i),
                        t.hktDatepicker._inDialog && (e.value = ''),
                        t.hktDatepicker._pos ||
                            ((t.hktDatepicker._pos = t.hktDatepicker._findPos(e)),
                            (t.hktDatepicker._pos[1] += e.offsetHeight)),
                        (r = !1),
                        t(e)
                            .parents()
                            .each(function () {
                        ...
                        t.hktDatepicker._updateDatepicker(i),
                        (o = t.hktDatepicker._checkOffset(i, o, r)),
                        i.dpDiv.css({
                        ...
                        i.inline ||
                            ((h = t.hktDatepicker._get(i, 'showAnim')),
                            (l = t.hktDatepicker._get(i, 'duration')),
                            i.dpDiv.zIndex(t(e).zIndex() + 1),
                            (t.hktDatepicker._datepickerShowing = !0),
                            t.effects && t.effects.effect[h]
                                ? i.dpDiv.show(h, t.hktDatepicker._get(i, 'showOptions'), l)
                                : i.dpDiv[h || 'show'](h ? l : null),
                            t.hktDatepicker._shouldFocusInput(i) && i.input.focus(),
                            (t.hktDatepicker._curInst = i))));
            }
        },
        _updateDatepicker: function (e) {
            ...
            (e.dpDiv.removeClass('ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4').width(''),
                ...
                e === t.hktDatepicker._curInst &&
                    t.hktDatepicker._datepickerShowing &&
                    t.hktDatepicker._shouldFocusInput(e) &&
                    e.input.focus(),
                e.yearshtml &&
                    ((i = e.yearshtml),
                    setTimeout(function () {
            ...
            !o ||
                ...
                (this._datepickerShowing &&
                    ...
                    t.effects && (t.effects.effect[i] || t.effects[i])
                        ? o.dpDiv.hide(i, t.hktDatepicker._get(o, 'showOptions'), s, n)
        ...
        _checkExternalClick: function (e) {
            if (t.hktDatepicker._curInst) {
                ...
                ((i[0].id !== t.hktDatepicker._mainDivId &&
                    0 === i.parents(`#${t.hktDatepicker._mainDivId}`).length &&
                    !i.hasClass(t.hktDatepicker.markerClassName) &&
                    !i.closest(`.${t.hktDatepicker._triggerClass}`).length &&
                    t.hktDatepicker._datepickerShowing &&
                    (!t.hktDatepicker._inDialog || !t.blockUI)) ||
                    (i.hasClass(t.hktDatepicker.markerClassName) && t.hktDatepicker._curInst !== s)) &&
                    t.hktDatepicker._hideDatepicker();
            }
        },
        _adjustDate: function (e, i, s) {
            ...
            this._isDisabledDatepicker(n[0]) ||
                (this._adjustInstDate(a, i + ('M' === s ? this._get(a, 'showCurrentAtPos') : 0), s),
        ...
        parseDate: function (i, s, n) {
            ...
            if (
                (-1 === g
                    ...
                    : 100 > g &&
                      (g += new Date().getFullYear() - (new Date().getFullYear() % 100) + (u >= g ? 0 : -100)),
                b > -1)
            ) {
                for (v = 1, _ = b; ; ) {
        ...
        _determineDate: function (e, i, s) {
            var n = function (t) {
                ...
                a = function (i) {
                    try {
                        return t.hktDatepicker.parseDate(
                            t.hktDatepicker._get(e, 'dateFormat'),
                            i,
                            t.hktDatepicker._getFormatConfig(e),
                        );
                    } catch (s) {}
                    for (
                        var n = (i.toLowerCase().match(/^c/) ? t.hktDatepicker._getDate(e) : null) || new Date(),
                            a = n.getFullYear(),
                            r = n.getMonth(),
                            o = n.getDate(),
        ...
        _generateHTML: function (t) {
            ...
            if ((0 > Z && ((Z += 12), te--), $)) {
                for (
                    e = this._daylightSavingAdjust(
                        new Date($.getFullYear(), $.getMonth() - Q[0] * Q[1] + 1, $.getDate()),
                    ),
                        e = G && G > e ? G : e;
            ...
            for (
                t.drawMonth = Z,
                    ...
                    s = this._canAdjustMonth(t, -1, te, Z)
                        ? `<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='${
                              i
                          }'><span class='ui-icon ui-icon-circle-triangle-${Y ? 'e' : 'w'}'>${i}</span></a>`
                        : J
                          ? ''
                    ...
                    a = this._canAdjustMonth(t, 1, te, Z)
                        ? `<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='${
                              n
                          }'><span class='ui-icon ui-icon-circle-triangle-${Y ? 'w' : 'e'}'>${n}</span></a>`
                        : J
                          ? ''
                ...
                for (w = '', this.maxRows = 4, D = 0; Q[1] > D; D++) {
                    ...
                    for (
                        M +=
                            `<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix${C}'>${
                                /all|left/.test(C) && 0 === k ? (Y ? a : s) : ''
                            }${/all|right/.test(C) && 0 === k ? (Y ? s : a) : ''}${this._generateMonthYearHeader(
                                t,
                                Z,
                                te,
                                G,
                            ...
                            S = u ? `<th class='ui-datepicker-week-col'>${this._get(t, 'weekHeader')}</th>` : '',
                            x = 0;
                        7 > x;
                        x++
                    ) {
                        ((N = (x + c) % 7),
                            (S +=
                                `<th${(x + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : ''}>` +
                                `<span title='${d[N]}'>${p[N]}</span></th>`));
                    }
                    for (
                        M += `${S}</tr></thead><tbody>`,
                        ...
                        for (
                            M += '<tr>',
                                F = u
                                    ? `<td class='ui-datepicker-week-col'>${this._get(t, 'calculateWeek')(H)}</td>`
                                    : '',
                                x = 0;
                            7 > x;
                            x++
                            ...
                            ((O = g ? g.apply(t.input ? t.input[0] : null, [H]) : [!0, '']),
                                (W = H.getMonth() !== Z),
                                (j = (W && !_) || !O[0] || (G && G > H) || ($ && H > $)),
                                (F += `<td class='${(x + c + 6) % 7 >= 5 ? ' ui-datepicker-week-end' : ''}${
                                    W ? ' ui-datepicker-other-month' : ''
                                }${
                                    (H.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent) ||
                                    ...
                                    W && !v
                                        ? ''
                                        : ` ${O[1]}${
                                              H.getTime() === X.getTime() ? ` ${this._currentClass}` : ''
                                          }${H.getTime() === L.getTime() ? ' ui-datepicker-today' : ''}`
                                }'${(W && !v) || !O[2] ? '' : ` title='${O[2].replace(/'/g, '&#39;')}'`}${
                                    j
                                        ? ''
                                        : ` data-handler='selectDay' data-event='click' data-month='${H.getMonth()}' data-year='${H.getFullYear()}'`
                                }>${
                                    W && !v
                                        ? '&#xa0;'
                                        : j
                                          ...
                                          : `<a class='ui-state-default${
                                                H.getTime() === L.getTime() ? ' ui-state-highlight' : ''
                    ...
                    (Z++,
                        ...
                        (M += `</tbody></table>${
                            q
                                ? `</div>${
                                      Q[0] > 0 && D === Q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : ''
                                  }`
                                : ''
                        }`),
                        (w += M));
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, a, r, o) {
            ...
            if (a || !g) {
                ...
                for (
                    ...
                    (!h || c >= s.getMonth()) &&
                        (!l || n.getMonth() >= c) &&
                        (y += `<option value='${c}'${c === e ? " selected='selected'" : ''}>${o[c]}</option>`);
                }
                y += '</select>';
            }
        ...
        (t.fn.hktDatepicker = function (e) {
            ...
            (t.hktDatepicker.initialized ||
                (t(document).mousedown(t.hktDatepicker._checkExternalClick), (t.hktDatepicker.initialized = !0)),
                0 === t(`#${t.hktDatepicker._mainDivId}`).length && t('body').append(t.hktDatepicker.dpDiv));
            ...
            return 'string' != typeof e || ('isDisabled' !== e && 'getDate' !== e && 'widget' !== e)
                ? 'option' === e && 2 === arguments.length && 'string' == typeof arguments[1]
                    ...
                    : this.each(function () {
                          'string' == typeof e
                              ? t.hktDatepicker[`_${e}Datepicker`].apply(t.hktDatepicker, [this].concat(i))
                              : t.hktDatepicker._attachDatepicker(this, e);
                      })
                : t.hktDatepicker[`_${e}Datepicker`].apply(t.hktDatepicker, [this[0]].concat(i));
        }),
        (t.hktDatepicker = new i()),
        (t.hktDatepicker.initialized = !1),
        (t.hktDatepicker.uuid = new Date().getTime()),
        (t.hktDatepicker.version = '1.10.3'));
})(jQuery);
