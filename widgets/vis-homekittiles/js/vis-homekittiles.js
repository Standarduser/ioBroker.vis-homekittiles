/*
    ...
    Copyright 2023 Standarduser github.com@sebastiankoehler.de
*/
"use strict";
    ...
    createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds["vis-homekittiles"].createWidget(widgetID, view, data, style);
            }, 100);
        }

        var text = '';
        text += 'OID: ' + data.oid + '</div><br>';
        text += 'OID value: <span class="vis-homekittiles-value">' + vis.states[data.oid + '.val'] + '</span><br>';
